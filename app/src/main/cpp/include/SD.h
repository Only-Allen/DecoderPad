...
****************************************************************************/
/* Copyright 1998-2013, Honeywell  All Rights Reserved */
...
#define  SD_CONST_VERDM    (1 << 13)
#define  SD_CONST_KP       (1 << 14)
#define  SD_CONST_CP       (1 << 16)
#define  SD_CONST_SP       (1 << 18) /* 17 conflicts with JP */
...
#define SD_PROP_RESULT_QR_POSITION               0x40007008
#define SD_PROP_RESULT_QRPOSITION            (SD_PROP_RESULT_QR_POSITION)
#define SD_PROP_RESULT_QR_TOTAL                  0x40007009
#define SD_PROP_RESULT_QRTOTAL               (SD_PROP_RESULT_QR_TOTAL)
#define SD_PROP_RESULT_QR_PARITY                 0x40007010
#define SD_PROP_RESULT_QRPARITY              (SD_PROP_RESULT_QR_PARITY)
...
#define SD_PROP_RESULT_MODULESX					    0x40007020
#define SD_PROP_RESULT_MODULESY					    0x40007021
#define SD_PROP_RESULT_2D_MODULESX				(SD_PROP_RESULT_MODULESX)
#define SD_PROP_RESULT_2D_MODULESY				(SD_PROP_RESULT_MODULESY)
...
#define SD_PROP_RESULT_QR_EC_LEVEL					 0x40007025
#define SD_PROP_RESULT_QR_MASK_VALUE  				 0x40007026
...
#define SD_PROP_OCR_ALLOW_MULTIPLE_SPACES        0x40012312
...
#define SD_PROP_VER_DM_ENABLED                   0x40013401
